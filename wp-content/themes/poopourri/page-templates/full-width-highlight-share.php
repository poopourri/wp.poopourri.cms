<?php
/**
 * Template Name: Home Page with Sharing
 *
...
get_header(); ?>
	...
	<div id="widget_highlight">
		...
		<p>
  		...
  		<iframe title="YouTube video player" class="youtube-player" type="text/html" width="630" height="355" src="http://www.youtube.com/embed/pmzxhLo25RM?rel=0&hd=1&wmode=transparent&autoplay=0&showinfo=0&color=white&autohide=1&rel=0&modestbranding=1&origin=https%3A%2F%2Fpoopourri.com" frameborder="0" style="position: absolute;left: 0px;top: 155px;box-shadow: 1px 2px 4px;"></iframe>
