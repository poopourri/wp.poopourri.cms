<?php
/**
 * Template Name: FREE Page Auto Popup #2
 *
...
$(document).ready(function(){
  if(document.location.href.indexOf('nosample')==-1){
    $.colorbox({iframe: true, href:"/t/free-sample2/",initialHeight:"450", maxWidth:"90%",maxHeight:"90%",minWidth:"825px",minHeight:"480px",opacity:0.8, innerWidth: '850px', innerHeight:'550px'});
  }
});
