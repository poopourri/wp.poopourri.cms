...
<div class="browse-right">
	...
	echo '<div style="height:100px;position:relative;">';
       if ($image_url = get_field("category_thumbnail", "foxyshop_categories_" . $term->term_id)) {
                echo '<img src="' . $image_url . '" class="alignleft foxyshop-main-cat-img" alt="' . esc_attr($term->name) . '" style="position:absolute;bottom:0px;left:0px;">';
        }
	//Write Category Title
	echo '<h1 id="foxyshop_category_title" class="screen-reader-text">' . str_replace("_","",$currentCategoryName) . '</h1>'."\n";
	echo '</div>';
